  ...
  return (
    <div className="container mx-auto py-8 px-4 space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        ...
        <Card className="bg-yellow-500/10 border-yellow-500/20 cursor-pointer hover:bg-yellow-500/20 transition-colors" onClick={() => navigate('/admin/tutors')}>
        ...
        <Card className="bg-red-500/10 border-red-500/20 cursor-pointer hover:bg-red-500/20 transition-colors" onClick={() => navigate('/admin/disputes')}>
